...
lazy val root = (project in file(".")).
  settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "org.apache.hadoop" % "hadoop-common" % "2.7.0" % "provided"  exclude ("org.apache.hadoop","hadoop-yarn-server-web-proxy") excludeAll ExclusionRule(organization = "javax.servlet"),
      "org.apache.spark" % "spark-sql_2.10" % "1.6.1" % "provided"  exclude ("org.apache.hadoop","hadoop-yarn-server-web-proxy"),
      "org.apache.spark" % "spark-hive_2.10" % "1.6.1" % "provided"  exclude ("org.apache.hadoop","hadoop-yarn-server-web-proxy"),
